...
export default function Footer() {
  ...
  return (
    ...
    <footer id='footer' className="z-20 min-h-32 h-fit py-10 px-2 mt-6 bg-white relative text-sm sm-450:text-xl">
        <div className="flex justify-around items-center w-full">
            ...
            <div>
                ...
                <ul style={{fontSize:"14px"}} className="mx-5 text-right md:text-left">
                    <li className='my-2' ><i class="fas fa-phone me-3"></i> 9345304080</li>
                    <li className='my-2' ><i class="fas fa-phone me-3"></i> 9345404080</li>
                    <li className='my-2' ><i class="fas fa-envelope me-3"></i> krishnaagency@gmail.com</li>
                    <li className='my-2' ><i class="fas fa-home me-3"></i> Vellore, Tamil Nadu-632006</li>
                </ul>
            </div>
            <div>
        ...
        <h6 className="text-center italic m-auto text-2xl">@Copyright reserved to :ASHWIN KUMAR K</h6>
    </footer>
    </>
  )
}
